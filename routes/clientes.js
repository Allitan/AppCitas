...
router.post('/registro', async (req, res) => {
    ...
    try {
        ...
        const insertQuery = 'INSERT INTO Cliente (Nombre, Email, Telefono, Contraseña) VALUES (?, ?, ?, ?)';
        const [result] = await db.promise().query(insertQuery, [Nombre, Email, Telefono, hashedPassword]);
